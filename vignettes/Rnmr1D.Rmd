...
The Rnmr1D package includes two compound databases:

* dbref6: 82 compounds, 500 NMR, pH 6, primarily compounds involved in primary plant metabolism 
* hmdb110: 110 compounds, 400/500/600 NMR, pH 7, primarily compounds involved in primary plant metabolism

It is possible to build your own database, based on the model below (e.g., dbref6).
<br>
...
g1 <- Rnmr1D::ggplotCriterion(clustcor)
#Rnmr1D::ggplotPlotly(g1, width=820, height=400)
g1
g2 <- Rnmr1D::ggplotCriterion(clusthca)
#Rnmr1D::ggplotPlotly(g2, width=820, height=400)
g2
```
...
g3 <- Rnmr1D::ggplotClusters(outMat,clustcor)
#Rnmr1D::ggplotPlotly(g3, width=820, height=400)
g3
g4 <- Rnmr1D::ggplotClusters(outMat,clusthca)
#Rnmr1D::ggplotPlotly(g4, width=820, height=400)
g4
...
g5 <- Rnmr1D::ggplotScores(pca$x, 1, 2, groups=out$samples$Treatment, EV=evnorm , gcontour="polygon")
...
g6 <- Rnmr1D::ggplotLoadings(pca$rotation, 1, 2, associations=clusthca$clustertab, EV=evnorm, main=sprintf("Loadings - Crit=%s",clusthca$vcrit), gcontour="ellipse" )
#Rnmr1D::ggplotPlotly(g6, width=820, height=650)
g6
```
...
g7 <- Rnmr1D::ggplotLoadings(pca.merged$rotation, 1, 2, associations=NULL, EV=evnorm)
#Rnmr1D::ggplotPlotly(g7, width=820, height=650)
g7
```
...
metadata <- Rnmr1D::generateMetadata(RAWDIR, procParams)
metadata
```
