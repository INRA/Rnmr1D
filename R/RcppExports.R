...
pvoigt <- function(x, x0, s, eta = 0.5) {
    .Call('_Rnmr1D_pvoigt', PACKAGE = 'Rnmr1D', x, x0, s, eta)
}
...
C_PVoigt <- function(ppm, amp, x0, sigma, eta = 0.5) {
    .Call('_Rnmr1D_C_PVoigt', PACKAGE = 'Rnmr1D', ppm, amp, x0, sigma, eta)
}
