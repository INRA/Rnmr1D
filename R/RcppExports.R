...
lorentz <- function(x, x0, s, a = 0) {
    .Call('_Rnmr1D_lorentz', PACKAGE = 'Rnmr1D', x, x0, s, a)
}

gauss <- function(x, x0, s, a = 0) {
...
C_FilterbyWT <- function(s, wavelet, threshold = 0.5, verbose = 0L) {
    .Call('_Rnmr1D_C_FilterbyWT', PACKAGE = 'Rnmr1D', s, wavelet, threshold, verbose)
}

C_FilterbyThreshold <- function(s, wavelet, threshold = 0L, verbose = 0L) {
    .Call('_Rnmr1D_C_FilterbyThreshold', PACKAGE = 'Rnmr1D', s, wavelet, threshold, verbose)
}

C_Lorentz <- function(ppm, amp, x0, sigma, a = 0) {
